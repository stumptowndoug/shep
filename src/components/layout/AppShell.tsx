...
export default function AppShell() {
  ...
  useEffect(() => {
    ...
    // The initial startup request can finish before listen() resolves. Read
    // the cache once the listener is installed so that result cannot be missed.
    void unlisten.then(() => {
      if (!disposed) void fetchUsageSnapshots();
    });
